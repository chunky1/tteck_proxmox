...
echo "deb [arch=amd64 signed-by=/etc/apt/trusted.gpg.d/adoptium.gpg] https://packages.adoptium.net/artifactory/deb buster main" >/etc/apt/sources.list.d/adoptium.list
$STD apt-get update
